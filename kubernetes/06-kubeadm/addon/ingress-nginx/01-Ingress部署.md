...
我选择的是GitHub上main中Tags是[nginx-30.0](https://github.com/kubernetes/ingress-nginx/blob/nginx-0.30.0/README.md#get-started) [Getting Started](https://kubernetes.github.io/ingress-nginx/deploy/) 1.18版本使用的配置  
