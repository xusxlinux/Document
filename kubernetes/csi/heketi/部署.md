...
# 这个名字记下
Name: vol_c3cd919418407f54c2bbef18e4f64721
Size: 1
...
# 挂载磁盘
``` shell
[root@hdss7-11 ~]# mount -t glusterfs -o backup-volfile-servers=10.4.7.22,10.4.7.11,10.4.7.21,log-level=WARNING hdss7-200.host.com:/vol_c3cd919418407f54c2bbef18e4f64721 /mnt/
